<template>
<div class='item_resumen-wrap'>
    <div  class='item_resumen-main' v-on:click='openDetails'>
        <div class='item_resumen-main-info'>
            <p class='item_resumen-main-info-date'>
                <slot name="date"/>
            </p>
            <p class='item_resumen-main-info-title'>
                <slot name="title"/>
            </p>
             <p :class='booking_status' class="item_resumen-main-info-state">
                <slot name="state"/>
             </p>
        </div>
        ...
        <div  class="item_resumen-main-reservation">
            <p class='item_resumen-main-reservation-number'>
                <span class='item_resumen-main-labels'>Reserva Nº:</span>
                <span class='_bold'>
                    <slot name="res_number"/>
                </span>
            </p>
            <p class='item_resumen-main-reservation-date'>
